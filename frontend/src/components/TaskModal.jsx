...
const TaskModal = ({
  ...
  // Update status when columnStatus changes
  useEffect(() => {
    setFormData((prev) => ({
      ...prev,
      status: columnStatus,
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-gradient-to-b from-slate-800/95 to-slate-900/95 rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto shadow-2xl border border-purple-500/20">
        {/* Header */}
